...
- 游戏：Atomic
- 类型：casual
- 简述：One tap, big bang — 屏幕上漂浮的原子，点一下引爆核心，链式反应能跑多远全看你选的点。爆链越久爆炸圈越大，雪球停不下来
- 框架 / 语言 / 构建：TypeScript, Vite
- 渲染方式：Canvas/WebGL
- 依赖摘录：vite@^5.1.0
- 平台元信息：meta.title=Atomic；cover_url=/poster.png；category=casual；uuid=11d74d8f-be44-4644-8828-3d3f3e927d84
